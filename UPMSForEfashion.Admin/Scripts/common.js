...
function checkTelephone(phone) {
    ...
    if (!/(^0[0-9]{2,3}-[0-9]{7,8}$)|(^0[0-9]{2,3}-[0-9]{7,8}-[0-9]{1,5}$)|(^1[0-9]{10}$)|(^400\d{7}$)/.test(phone)) {
        return false;
    }
    return true;
}
...
function validatePhone(phone) {
    ...
    for (var i = 0; i < l; i++) {
        if (!/(^0[0-9]{2,3}-[0-9]{7,8}$)|(^0[0-9]{2,3}-[0-9]{7,8}-[0-9]{1,5}$)|(^1[0-9]{10}$)|(^400\d{7}$)/.test(arrPhone[i])) {
            return false;
        }
    }
